...
public:
	...
	{
		//Ð²Ð¼ÐµÑÑ‚Ð¾ ÑÑ‚Ñ€Ð¸Ð³ÑÑ‚Ñ€Ð¸Ð¼ Ð±ÑƒÑ„ÐµÑ€
		std::ostringstream archive_stream;
		std::ostream archive_stream_b(archive_stream.rdbuf());
		boost::archive::text_oarchive archive(archive_stream_b);
		archive << t; //Ð°Ñ€Ñ…Ð¸Ð² Ð´Ð¾Ð»Ð¶ÐµÐ½ Ð¾ÑÐ½Ð¾Ð²Ñ‹Ð²Ð°Ñ‚ÑŒÑÑ Ð½Ð° Ð´Ñ€ÑƒÐ³Ð¾Ð¼ Ð¿Ð¾Ñ‚Ð¾ÐºÐµ
					  //Ð´Ð°Ð»ÑŒÑˆÐµ Ð¸Ð´ÐµÑ‚ Ñ€Ð°Ð±Ð¾Ñ‚Ð° Ñ ÑÐ°Ð¼Ð¸Ð¼ Ð¿Ð¾Ñ‚Ð¾ÐºÐ¾Ð¼
